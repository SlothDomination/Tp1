...
//import {AnimNav} from './AnimNav.js' //
import {AnimTextFooter} from './AnimTextFooter.js';
...
function animationLettre()
{
	...
	const lesLettres = 'Veille-technologique';
 	let  monAnimLettre = new AnimLettre(lesLettres, elmHeader, finAnim);/*(truc, conteneur parent, fonction)*/
}
